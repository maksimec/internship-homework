...
**Результат:** [`task_1/comparison_table_of_providers.pdf`](task_1/comparison_table_of_providers.pdf) · [Google Sheets](https://docs.google.com/spreadsheets/d/1lchwz-BEHLdp-lkNe1LnVATvRJrkX3K3FvMfvVeb26M/view)
...
| Скріншот                                                                                              | Опис                                    |
|-------------------------------------------------------------------------------------------------------|-----------------------------------------|
| [`subtask_3/associated_elastic_ip.png`](task_5/subtask_3/associated_elastic_ip.png)                  | Elastic IP, прив'язана до EC2           |
